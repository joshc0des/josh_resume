...
\Header
    {Joshua Hooper} % name
    {San Antonio, TX} % city, province
    {405-308-3676} % phone number
    {joshuahooper3@gmail.com} % email
    {joshooper} % https://linkedin.com/in/_______
...
\begin{Skills}
	...
	{Languages}
	{
		\skill{C\#} \skill{HTML/CSS} \skill{Java} \skill{JavaScript/TypeScript} \skill{Golang} \skill{Python} \skill{SQL}
	}
	\SkillCategory
	{Frameworks}
	{
	...
	{Database Systems}
	{
		\skill{Microsoft SQL Server} \skill{Elasticsearch} \skill{Redis} \skill{MongoDB} \skill{Oracle} \skill{Postgres}
	}
	\SkillCategory
	{Software}
	{
		\skill{Kubernetes} \skill{Esri ArcGIS} \skill{Vim} \skill{Splunk} \skill{VS Code} \skill{Visual Studio} \skill{K9s}
	}	
\end{Skills}
\vspace{-0.8em}
